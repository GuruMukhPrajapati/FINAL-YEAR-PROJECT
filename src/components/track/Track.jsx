                    ...
                    <div className="flex flex-wrap -m-4 text-center">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg" 
                                ...
                                <p className="leading-relaxed">Our T-Shirts are made of 100% pure cotton for maximum comfort.</p>
                            </div>
                        </div>
                        {/* Card 2: Stylish Hoodies */}
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg" 
                                style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
                                ...
                                <h2 className="title-font font-medium text-lg text-gray-900">Stylish Hoodies</h2>
                                <p className="leading-relaxed">Stay warm and fashionable with our high-quality hoodies.</p>
                            </div>
                        </div>
                        {/* Card 3: Trendy Sneakers */}
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg" 
                                style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
                                ...
                                <p className="leading-relaxed">Step up your style with our latest collection of cloths.</p>
                            </div>
                        </div>
                    </div>
                </div>
